...
exports.sourceNodes = async (
  ...
  const postsQuery = await fetch(
    `https://api.dropinblog.com/v1/json/?b=${id}&includecontent=1`
  )
  ...
  const authorsQuery = await fetch(
    `https://api.dropinblog.com/v1/json/authors/?b=${id}`
  )
  ...
  const categoriesQuery = await fetch(
    `https://api.dropinblog.com/v1/json/categories/?b=${id}`
  )
